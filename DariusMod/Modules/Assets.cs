...
namespace DariusMod.Modules
{
    internal static class Assets
    {
        ...
        // CHANGE THIS
        private const string assetbundleName = "dariusbundle";
        //change this to your project's name if/when you've renamed it
        private const string csProjName = "DariusMod";
        
        internal static void Initialize()
        {
            if (assetbundleName == "Henyrybundle")
            {
        ...
        {                                                                
            ...
            using (Stream manifestResourceStream2 = Assembly.GetExecutingAssembly().GetManifestResourceStream($"{csProjName}.DariusBank.bnk"))
            {
        ...
        internal static void PopulateAssets()
        {
            ...
            swordHitSoundEvent = CreateNetworkSoundEventDef("DariusSwordHit");

            bombExplosionEffect = LoadEffect("BombExplosionEffect", "DariusBombExplosion");
            ...
            swordSwingEffect = Assets.LoadEffect("DariusSwordSwingEffect", true);
            swordHitImpactEffect = Assets.LoadEffect("ImpactDariusSlash");
        }
